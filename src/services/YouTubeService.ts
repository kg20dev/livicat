...
export class YouTubeService {
  ...
  /**
   * Check if a video is currently live streaming by checking for
   * liveStreamingDetails.actualStartTime in the video metadata.
   */
  ...
  extractVideoId(input: string): string | null {
    ...
    // Direct video ID (11 characters, alphanumeric + underscore + dash)
